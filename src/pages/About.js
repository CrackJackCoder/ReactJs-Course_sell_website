...
function About() {
    return (
        <div className="relative flex flex-col bg-white text-white h-screen overflow-hidden">
            <div className="bg-black h-2/4 rounded-b-[300px] max-md:rounded-b-[200px] max-sm:rounded-b-[150px]">
            ...
            <img src={Person} className="absolute bottom-0 sm:max-w-[70%] md:max-w-[60%] lg:max-w-[45%] bounce"></img>
            ...
            <img src={Horizon} className="w-[100vw] top-[-75%] absolute max-xl:top-[-50%] max-lg:top-[-25%] max-md:top-[-5%] max-sm:top-[15%]"></img>
        </div>
    );
}
